 ...
 * AWSSimpleSystemsManagementClientBuilder; import
 ...
 * 
 * @Service public class SSMParameterService {
 * 
 * private final AWSSimpleSystemsManagement ssmClient;
 * 
 * public SSMParameterService() { this.ssmClient =
 * AWSSimpleSystemsManagementClientBuilder.defaultClient(); }
 * 
 * public String getSSMParameter(String parameterName) { GetParameterRequest
 * request = new GetParameterRequest() .withName(parameterName)
 * .withWithDecryption(true); // Decrypt the parameter if it's encrypted
 * 
 * GetParameterResult result = ssmClient.getParameter(request); return
